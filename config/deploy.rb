...
role :web, "challenge.com"                          # Your HTTP server, Apache/etc
role :app, "challenge.com"                         # This may be the same as your `Web` server
role :db,  "challenge.com"   , :primary => true # This is where Rails migrations will run
